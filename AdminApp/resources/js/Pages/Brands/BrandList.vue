...
<script setup>
    ...
    const columns = [
        ...
        { key: 'image', label: 'Image', slot: 'image-slot', sortable: false, searchable: false },
        { key: 'actions', label: 'Actions', slot: 'actions-slot', sortable: false, searchable: false },
    ]
    ...
    <Layout>
        ...
        <main class="ml-64 p-8">
            ...
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <TableComponent :data="brands" :columns="columns" :pageSize="5">
