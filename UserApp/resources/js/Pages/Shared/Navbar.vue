    ...
    <div class="container mx-auto px-4 flex justify-between items-center py-1">
      <div class="flex items-center space-x-4">
        <div class="flex items-center space-x-1">
          <img src="@/assets/logo-e3.webp" alt="Logo" class="h-25" />
          <!-- <span class="text-base font-bold"><span class="text-black text-xl">E</span>-Shop</span> -->
        </div>

        <Link href="/" class="text-lg font-[400] text-black hover:text-blue-500">Home</Link>
        <Link href="/carts" class="text-lg  text-semi-bold hover:text-blue-500">Cart</Link>
        <Link href="/wishlists" class="text-lg  text-semi-bold hover:text-blue-500">Wishlist</Link>
      </div>
      <div class="relative">
        ...
        <!-- <div v-if="true"> -->
          ...
          <Link href="/login" class="text-lg  text-semi-bold hover:text-blue-500 me-5">Login</Link>
          <Link href="/register" class="text-lg  text-semi-bold hover:text-blue-500">Register</Link>
